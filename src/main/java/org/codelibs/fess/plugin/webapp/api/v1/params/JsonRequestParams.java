...
/**
 * Search request parameters extracted from a JSON API HTTP request.
 */
public class JsonRequestParams extends SearchRequestParams {
     ...
     */
    public JsonRequestParams(final HttpServletRequest request, final FessConfig fessConfig) {
