...
public class SearchApiManagerTest extends UnitWebappTestCase {
    ...
    /**
     * Verifies that the {@link Date} branch of {@code AbstractApiHandler.escapeJson(Object)} keeps
        ...
        for (final String tzId : new String[] { "UTC", "Asia/Tokyo", "America/Los_Angeles", "Europe/Paris" }) {
            ...
            try {
                ...
                for (final long epochMillis : new long[] { 0L, 1L, 1_700_000_000_000L, 1_736_000_000_123L, System.currentTimeMillis() }) {
                    ...
                    final String actual = AbstractApiHandler.escapeJson(date);
    ...
    /**
     * The output of {@code AbstractApiHandler.escapeJson(Date)} must be a JSON string in
     * yyyy-MM-dd'T'HH:mm:ss.SSS&#177;HHmm form, surrounded by double quotes.
     */
    @Test
    public void test_escapeJson_dateFormatShape() {
        final String result = AbstractApiHandler.escapeJson(new Date(0L));
