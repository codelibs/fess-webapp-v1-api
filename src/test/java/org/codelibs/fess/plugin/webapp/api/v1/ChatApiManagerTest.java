...
/**
 * Unit tests for the RAG chat API handlers ({@link ChatHandler} and {@link ChatStreamHandler}).
 * Tests are kept in this class (previously {@code ChatApiManagerTest}) to preserve history.
 */
public class ChatApiManagerTest extends UnitWebappTestCase {
    ...
    public void test_defaultConstructor() {
        assertNotNull(new ChatHandler());
        assertNotNull(new ChatStreamHandler());
    }
    ...
    public void test_matches_ragChatDisabled() {
        ...
        assertFalse(chatHandler.matches(request));
        assertFalse(chatStreamHandler.matches(request));
    }
    ...
    public void test_matches_ragChatEnabled_validPath() {
        ...
        assertTrue(chatHandler.matches(request));
    }
    ...
    public void test_matches_ragChatEnabled_streamPath() {
        ...
        assertTrue(chatStreamHandler.matches(request));
    }
    ...
    public void test_createSuccessResponse_basic() {
        final Map<String, Object> response = chatHandler.createSuccessResponse("session-123", "Hello, world!", null);
    ...
    public void test_createSuccessResponse_withSources() {
        ...
        final Map<String, Object> response = chatHandler.createSuccessResponse("session-123", "Response content", sources);
    ...
    public void test_createSuccessResponse_nullContent() {
        final Map<String, Object> response = chatHandler.createSuccessResponse("session-123", null, null);
    ...
    public void test_createSuccessResponse_emptySessionId() {
        final Map<String, Object> response = chatHandler.createSuccessResponse("", "Content", null);
    ...
    public void test_createErrorResponse_basic() {
        final Map<String, Object> response = chatHandler.createErrorResponse("Something went wrong");
    ...
    public void test_createErrorResponse_emptyMessage() {
        final Map<String, Object> response = chatHandler.createErrorResponse("");
    ...
    public void test_createErrorResponse_nullMessage() {
        final Map<String, Object> response = chatHandler.createErrorResponse(null);
    ...
    public void test_sendSseEvent_basic() {
        ...
        chatStreamHandler.sendSseEvent(writer, "test", Map.of("key", "value"));
    ...
    public void test_sendSseEvent_session() {
        ...
        chatStreamHandler.sendSseEvent(writer, "session", Map.of("sessionId", "abc-123"));
    ...
    public void test_sendSseEvent_phase() {
        ...
        chatStreamHandler.sendSseEvent(writer, "phase", Map.of("phase", "search", "status", "start", "message", "Searching documents"));
    ...
    public void test_sendSseEvent_chunk() {
        ...
        chatStreamHandler.sendSseEvent(writer, "chunk", Map.of("content", "Hello "));
    ...
    public void test_sendSseEvent_error() {
        ...
        chatStreamHandler.sendSseEvent(writer, "error", Map.of("phase", "generation", "message", "Model unavailable"));
    ...
    public void test_sendSseEvent_done() {
        ...
        chatStreamHandler.sendSseEvent(writer, "done", Map.of("sessionId", "session-123"));
    ...
    public void test_sendSseEvent_done_withHtmlContent() {
        ...
        chatStreamHandler.sendSseEvent(writer, "done", Map.of("sessionId", "session-123", "htmlContent", "<p>Response</p>"));
    ...
    public void test_sendSseEvent_specialCharacters() {
        ...
        chatStreamHandler.sendSseEvent(writer, "chunk", Map.of("content", "Special chars: \"quotes\" and \\ backslash"));
    ...
    public void test_sendSseEvent_unicode() {
        ...
        chatStreamHandler.sendSseEvent(writer, "chunk", Map.of("content", "Unicode: 日本語 中文"));
    ...
    public void test_sendSseEvent_emptyMap() {
        ...
        chatStreamHandler.sendSseEvent(writer, "test", Map.of());
    ...
    public void test_sendSseEvent_nestedData() {
        ...
        chatStreamHandler.sendSseEvent(writer, "test", nestedData);
    ...
    public void test_sendSseEvent_listData() {
        ...
        chatStreamHandler.sendSseEvent(writer, "test", Map.of("items", items));
    ...
    public void test_sendSseEvent_retry_writesEventAndJson() {
        ...
        try (PrintWriter pw = new PrintWriter(sw)) {
            chatStreamHandler.sendSseEvent(pw, "retry", Map.of("phase", "answer", "attempt", 2, "maxAttempts", 5, "sleepMs", 4000L));
        }
    ...
    public void test_sendSseEvent_waiting_writesPayload() {
        final StringWriter sw = new StringWriter();
        try (PrintWriter pw = new PrintWriter(sw)) {
            chatStreamHandler.sendSseEvent(pw, "waiting", Map.of("phase", "answer", "reason", "concurrency_limit", "timeoutMs", 30000L));
        }
        final String out = sw.toString();
    ...
    public void test_sendSseEvent_fallback_writesPayload() {
        final StringWriter sw = new StringWriter();
        try (PrintWriter pw = new PrintWriter(sw)) {
            chatStreamHandler.sendSseEvent(pw, "fallback",
    ...
    public void test_sendSseEvent_warning_writesPayload() {
        final StringWriter sw = new StringWriter();
        try (PrintWriter pw = new PrintWriter(sw)) {
            chatStreamHandler.sendSseEvent(pw, "warning",
                    Map.of("phase", "intent", "code", "reasoning_token_exhausted", "detail", "search"));
        }
        final String out = sw.toString();
    ...
    public void test_createSuccessResponse_emptySources() {
        final List<ChatSource> sources = new ArrayList<>();
        final Map<String, Object> response = chatHandler.createSuccessResponse("session-123", "Content", sources);
    ...
    public void test_getMaxMessageLength_default() {
        ...
        final int result = chatHandler.getMaxMessageLength(ComponentUtil.getFessConfig());
    ...
    public void test_parseExtraQueries_null() {
        ...
        final MockHttpServletRequest request = new MockHttpServletRequest();
        // ex_q not set (null)
        final String[] result = chatHandler.parseExtraQueries(request);
